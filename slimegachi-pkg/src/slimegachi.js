...
(function (global) {
  ...
  function widgetHTML(showDev) {
    return [
      ...
      '  <p style="text-align:center;font-size:11px">Your coins: <strong style="color:var(--slimegachi-coin);font-family:var(--slimegachi-font-display)" data-sg="shop-coins">0</strong></p>',
      ...
      '  <p style="text-align:center;font-size:11px;color:var(--slimegachi-dim)">Unlocked <strong data-sg="ach-count" style="color:var(--slimegachi-coin);font-family:var(--slimegachi-font-display)">0/0</strong></p>',
      ...
      '  <p style="text-align:center;font-size:11px">Your coins: <strong style="color:var(--slimegachi-coin);font-family:var(--slimegachi-font-display)" data-sg="feed-coins">0</strong></p>',
  ...
  function createInstance(container, userOptions) {
    ...
    const BubblePop = {
      ...
      loop() {
        ...
        this._last = tNow;
        if (dt > 100) dt = 100;
        dt *= 4;  /* 4x game speed (scales both fall speed and spawn cadence) */
        const f = dt / 16.667;
        this.spawnTimer -= dt;
      ...
      loop() {
        ...
        if (this.spawnTimer <= 0) {
          ...
          if (roll < 0.05) {
            ...
            item = { kind: 'banana', x: 20 + Math.random() * (this.width - 40), y: -20, vy: 2.0 + Math.random() * 1.8, points: 5, radius: 48 };
          }
